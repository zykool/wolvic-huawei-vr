...
public class VRBrowserActivity extends PlatformActivity implements WidgetManagerDelegate,
    ...
    @Override
    public void setVRVideoPitch(final float aPitch) {
        queueRunnable(() -> setVRVideoPitchNative(aPitch));
    }

    @Override
    public float getVRVideoPitch() {
        // Need to get from native thread, use a temporary callable
        return getVRVideoPitchNative();
    }

    @Override
    public boolean isVRVideo180() {
        return isVRVideo180Native();
    }
